...
class entryBar extends HTMLElement{
	constructor() {
		...
		template.innerHTML = `
			...
			<div class="initial">
				<svg class="inactive-bar" width="61" height="36" viewBox="0 0 61 36" fill="none" xmlns="http://www.w3.org/2000/svg">
				...
				<div class="active-bar">
					<span class="close">&times;</span>
						<div class="dropdown">
							<svg class="new-entry" width="111" height="137" viewBox="0 0 111 137" fill="none" xmlns="http://www.w3.org/2000/svg">
								<path fill-rule="evenodd" clip-rule="evenodd" d="M68.9167 1.41663H15.25C7.84018 1.41663 1.83334 7.42347 1.83334 14.8333V122.167C1.83334 129.576 7.84018 135.583 15.25 135.583H95.75C103.16 135.583 109.167 129.576 109.167 122.167V41.6666L68.9167 1.41663Z" stroke="black" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
...
function deleteNote() {
	...
	if(response){
		...
		if(innerBar.children[0]){
			innerBar.children[0].style.marginLeft = "2rem";
		}
